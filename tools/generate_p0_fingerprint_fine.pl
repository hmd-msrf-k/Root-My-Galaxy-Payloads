...
# Use 0x200 step for finer granularity
my $step = 0x200;
# Cover full 0x1f0000 range (248 entries)
...
// Fine-grained 0x200 step for precise slide matching.
...
printf "generated %d rows with 0x200 step (range 0x000000 to 0x%x)\n", scalar(@rows), ($rows-1)*$step;
